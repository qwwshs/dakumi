...
local function draw_this_button()
    ...
    ui_style:button(x,y,w,h,objact_language.get_string_in_languages("file select"))
end
...
local function will_do()
    ...
    if selectedFile ~= nil then
        ...
        objact_message_box.message_window_dlsplay("选择的文件: " .. filepath,function() end,function() end)
    end
end
