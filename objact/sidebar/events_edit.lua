...
local function draw_events_button_do()
    ui_style:button(x+ w + 10,700,100,25,objact_language.get_string_in_languages("do"))
end
...
objact_events_edit = {
    ...
    draw = function()
        ...
        love.graphics.print(objact_language.get_string_in_languages("perturbation"),x,100)
        love.graphics.print(objact_language.get_string_in_languages("from"),x,150)
        love.graphics.print(objact_language.get_string_in_languages("to"),x,200)
        love.graphics.print(objact_language.get_string_in_languages("trans_expression"),x,250)
        love.graphics.print(objact_language.get_string_in_languages("quick_adjustments"),x,300)
            --函数图像绘制
