...
objact_track_sidebar = {
    ...
    draw = function()
        ...
        love.graphics.setColor(1,1,1,1)
        love.graphics.print(objact_language.get_string_in_languages('track'),x,y+20) 
        love.graphics.print('x',x+80,y+20) 
        love.graphics.print('w',x+140,y+20) 

        love.graphics.print('x'..objact_language.get_string_in_languages('sift'),x+250,y+10) 
        love.graphics.print('w'..objact_language.get_string_in_languages('sift'),x+250,y+50) 
