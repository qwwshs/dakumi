...
objact_note_edit = {  --编辑界面
    load = function(x1,y1,r1,w1,h1)
        ...
        input_box_new(get_displayed_content_1_4().."beat_start1","chart.note["..string.sub(displayed_content,5,#displayed_content).."].beat[1]",x + 140,y + 100,30,30,{type = "number",will_draw = will_draw,input_ed_finish = input_ed})
        input_box_new(get_displayed_content_1_4().."beat_start2","chart.note["..string.sub(displayed_content,5,#displayed_content).."].beat[2]",x + 180,y + 100,30,30,{type = "number",will_draw = will_draw,input_ed_finish = input_ed})
        input_box_new(get_displayed_content_1_4().."beat_start3","chart.note["..string.sub(displayed_content,5,#displayed_content).."].beat[3]",x + 220,y + 100,30,30,{type = "number",will_draw = will_draw,input_ed_finish = input_ed})
        if chart.note[tonumber(string.sub(displayed_content,5,#displayed_content))].type == "hold" then
            input_box_new(get_displayed_content_1_4().."beat_end1","chart.note["..string.sub(displayed_content,5,#displayed_content).."].beat2[1]",x + 140,y + 150,30,30,{type = "number",will_draw = will_draw,input_ed_finish = input_ed})
            input_box_new(get_displayed_content_1_4().."beat_end2","chart.note["..string.sub(displayed_content,5,#displayed_content).."].beat2[2]",x + 180,y + 150,30,30,{type = "number",will_draw = will_draw,input_ed_finish = input_ed})
            input_box_new(get_displayed_content_1_4().."beat_end3","chart.note["..string.sub(displayed_content,5,#displayed_content).."].beat2[3]",x + 220,y + 150,30,30,{type = "number",will_draw = will_draw,input_ed_finish = input_ed})
        else
